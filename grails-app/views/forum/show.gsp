...
<html>
    ...
    <body>
        ...
        <div id="show-forum" class="content scaffold-show" role="main">
            ...
            <f:display bean="forum" />
            <g:form resource="${this.forum}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.forum}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
